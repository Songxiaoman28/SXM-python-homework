...
plt.plot(all_confirmed,c='r',label='确诊',marker ='o',linewidth=5,markersize=15)
plt.plot(all_recovered,c = 'b',label = '治愈',marker = 'o',linewidth=5,markersize=15)
plt.plot(all_deaths,c = 'lime',label = '死亡',marker = 'o',linewidth=5,markersize=15)
plt.xticks(rotation=45,size=30)
plt.yticks(size=40)
plt.xlabel('时 间',size = 60)
plt.ylabel('数 目',size = 60)
plt.title('全球疫情变化趋势',size = 70)
...
Mainland_china.plot(kind='barh', figsize=(20,10), color = ['red','blue','lime'],
width=1, rot=2)
...
```{python}
plt.figure(figsize=(40,20))
plt.plot(recover_rate, color = 'blue', label = '治愈率', marker = 'o',linewidth=5,markersize=15)
plt.plot(death_rate, color = 'lime', label = '死亡率', marker = 'o',linewidth=5,markersize=15)
plt.title('中国大陆治愈率 VS 死亡率',size=70)
plt.ylabel('数量',size=60)
plt.xlabel('时间',size=60)
plt.xticks(rotation=45,size=30)
plt.yticks(size=40)
plt.legend(loc = "upper left",fontsize = 45)
plt.show()
...
```{python}
plt.figure(figsize=(40,20))
plt.plot(other_recover_rate, color = 'blue', label = '治愈率', marker = 'o',linewidth=5,markersize=15)
plt.plot(other_death_rate, color = 'lime', label = '死亡率', marker = 'o',linewidth=5,markersize=15)
plt.title('其他地区治愈率 VS 死亡率',size=65)
plt.ylabel('数量',size=60)
plt.xlabel('时间',size=60)
plt.xticks(rotation=45,size=30)
plt.yticks(size=40)
...
## 世界其他地区疫情数量
```{python}
others_countries.sort_values(by = 'confirmed',ascending = True).plot(kind='barh', figsize=(20,10), color = ['red','blue','lime'], width=1, rot=2)
...
```{r fig1,eval=T, echo=F,out.width="90%", fig.align='center',fig.cap="亚洲地区疫情扩散图",dev="png",results='markup', cache=F}
...
fig.show()
```
```{r fig2,eval=T, echo=F,out.width="90%", fig.align='center',fig.cap="亚洲地区疫情扩散图",dev="png",results='markup', cache=F}
