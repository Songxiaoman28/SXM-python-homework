...
# 数据可视化
## 全球疫情变化趋势图
```{python world, fig.cap="全球疫情变化趋势", dev='pdf',eval=TRUE}
...
## 中国大陆治愈率VS死亡率趋势图
```{python cn, fig.cap="中国大陆治愈率 VS 死亡率", dev='pdf',eval=TRUE}
fig,ax = plt.subplots() 
xt=[d[:-3] for d in all_confirmed.index]#取月日
...
## 其他地区治愈率 VS 死亡率趋势图
```{python other, fig.cap="其他地区治愈率 VS 死亡率", dev='pdf',eval=TRUE}
fig,ax = plt.subplots() 
xt=[d[:-3] for d in all_confirmed.index]#取月日
...
```{r wordmap,eval=T, echo=F,out.width="90%", fig.align='center',fig.cap="亚洲地区疫情扩散图",dev="png",results='markup', cache=F}
...
fig.show()
```
```{r map,eval=T, echo=F,out.width="90%", fig.align='center',fig.cap="亚洲地区疫情扩散图",dev="png",results='markup', cache=F}
